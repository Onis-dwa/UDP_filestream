...
struct packetData {
	...
	packetType type;         // тип пакета переместил вниз, из-за выравнивани€
...
class udp_socket {
	/* кросс платформенна€ обЄртка дл€ сокета */
public:
	...
	int udp_send (const packetData& pd, const int dataSize); // отправка использу€ _address
